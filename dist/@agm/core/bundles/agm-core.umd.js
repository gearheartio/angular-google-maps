    ...
    ***************************************************************************** */
    ...
    var MvcArrayMock = /** @class */ (function () {
        ...
        MvcArrayMock.prototype.getArray = function () {
            return __spreadArray([], __read(this.vals));
        };
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, pathsChanges$.pipe(operators.startWith({ newArr: paths.getArray() }), // in order to subscribe to them all
                                operators.switchMap(function (parentMVEvent) { return rxjs.merge.apply(void 0, __spreadArray([], __read(// rest parameter
    ...
    var AgmMap = /** @class */ (function () {
        ...
        AgmMap.propDecorators = {
            ...
            fitBoundsPadding: [{ type: core.Input }],
            ...
            showDefaultInfoWindow: [{ type: core.Input }],
            gestureHandling: [{ type: core.Input }],
            tilt: [{ type: core.Input }],
            restriction: [{ type: core.Input }],
    ...
    var AgmPolygon = /** @class */ (function () {
        ...
        AgmPolygon.propDecorators = {
            ...
            polyPathsChange: [{ type: core.Output }]
        };
        return AgmPolygon;
    }());
    ...
    var AgmPolylineIcon = /** @class */ (function () {
        ...
        AgmPolylineIcon.decorators = [
            { type: core.Directive, args: [{ selector: 'agm-polyline agm-icon-sequence' },] }
        ];
        AgmPolylineIcon.propDecorators = {
            fixedRotation: [{ type: core.Input }],
            offset: [{ type: core.Input }],
            repeat: [{ type: core.Input }],
            anchorX: [{ type: core.Input }],
            anchorY: [{ type: core.Input }],
            fillColor: [{ type: core.Input }],
            fillOpacity: [{ type: core.Input }],
    ...
    var AgmPolylinePoint = /** @class */ (function () {
        ...
        AgmPolylinePoint.decorators = [
            { type: core.Directive, args: [{
                        ...
                        providers: [
                            { provide: FitBoundsAccessor, useExisting: core.forwardRef(function () { return AgmPolylinePoint; }) },
                        ],
                    },] }
        ];
    ...
    var AgmPolyline = /** @class */ (function () {
        ...
        AgmPolyline.propDecorators = {
            ...
            polyPathChange: [{ type: core.Output }],
            points: [{ type: core.ContentChildren, args: [AgmPolylinePoint,] }],
            iconSequences: [{ type: core.ContentChildren, args: [AgmPolylineIcon,] }]
        };
        return AgmPolyline;
    }());
